...
{
    public partial class Fdamedatoscontrato : Form
    {
        public Fdamedatoscontrato()
        ...
        private void btaceptar_Click(object sender, EventArgs e)
        {

            {
              ...
              //  ztestigo2.Text = "ALAN ADRIAN GAMBOA NAVARRO";
                ...
                string linea1e = "B) Que acredita su personalidad con credencial para votar No. " + mcreden.Text.Trim() + " y con cédula de identificación fiscal de folio No. " + mfiscal.Text.Trim() + ", ";
                string linea2e = "con domicilio fiscal " + mdirec1.Text.ToUpper().Trim() + " " + mdirec2.Text.ToUpper().Trim() + " " + mdirec3.Text.ToUpper().Trim() + " ";
                string linea3e = "";
                if (mimss.Text != " ") { linea3e = "y número de registro patronal del IMSS " + mimss.Text.Trim() + "."; };
               ...
               //     ztestigo2.Text = "ALAN ADRIAN GAMBOA NAVARRO";
                ...
                {
               //     laempresa.Text = "Ediciones Litográficas, S. A.";
               //     zreplegal.Text = "";
               //     ztestigo1.Text = "";
               //     ztestigo2.Text = "";
                ...
                {
                //    laempresa.Text = "Terminados Litográficos, S. A. de C. V.";
                //    zreplegal.Text = "LUIS ALFONSO GIL GUERRA";
                //    ztestigo1.Text = "JOSÉ ABEL GIL ZUÑIGA";
                //    ztestigo2.Text = "JORGE LIRA ESTRADA";
                ...
                string rutalg = "C:/presupvisual/usuarios/proveedores-contratos/LitoGil/LG-SERVICIOS-(PF)-" + mproveedor.Text;
                string rutael = "C:/presupvisual/usuarios/proveedores-contratos/EdiLito/EL-SERVICIOS-(PF)-" + mproveedor.Text;
                string rutatl = "C:/presupvisual/usuarios/proveedores-contratos/Terminados/TL-SERVICIOS-(PF)-" + mproveedor.Text;
                //string rutalg = "//server/presupvisual/usuarios/proveedores-contratos/LitoGil/LG-SERVICIOS-(PF)-" + mproveedor.Text;
                //string rutael = "//server/presupvisual/usuarios/proveedores-contratos/EdiLito/EL-SERVICIOS-(PF)-" + mproveedor.Text;
                //string rutatl = "//server/presupvisual/usuarios/proveedores-contratos/Terminados/TL-SERVICIOS-(PF)-" + mproveedor.Text;
                ...
                string linea4 = "'EL CLIENTE' Y, POR LA OTRA PARTE: " + mrazon.Text.ToUpper().Trim() + ", A QUIEN EN LO SUCESIVO SE LE DENOMINARÁ 'EL PRESTADOR'.  ";
                ...
                objParrfafo10.Range.Text = linea1e + linea2e + linea3e;
                ...
                objParrfafo11.Range.Text = "C) Que presta servicios en forma independiente y que cuenta con diversos clientes. ";
                ...
                string linea5a = "D) Que tiene una amplia experiencia en la prestación de los SERVICIOS, que cuenta con las, licencias y ";
                string linea5b = "autorizaciones legales requeridas para prestar los SERVICIOS y que, en su caso, cuenta con el título profesional requerido para ello.  ";
                objParrfafo12.Range.Text = linea5a + linea5b;
                ...
                string linea17a = "C) 'EL PRESTADOR' es el único obligado como empresario y patrón del personal que ocupa con motivo del presente contrato y que será el único responsable ";
                string linea17b = "de sus obligaciones fiscales, laborales y de los riesgos de seguridad social ante el Instituto Mexicano del Seguro Social, así como los del INFONAVIT, ";
                string linea17c = "FONACOT y de la Secretaria del Trabajo y conviene por lo mismo en responder de todas las reclamaciones que sus trabajadores presten en su contra ";
                string linea17d = "o en contra de 'EL CLIENTE'  en relación con los trabajos, motivos del presente contrato. ";
