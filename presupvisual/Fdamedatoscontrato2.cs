...
{
    public partial class Fdamedatoscontrato2 : Form
    {
        public Fdamedatoscontrato2()
        {
            InitializeComponent();
        ...
        private void btaceptar_Click(object sender, EventArgs e)
        {

            {
                ...
                string rutalg = "C:/presupvisual/usuarios/proveedores-contratos/LitoGil/LG-SERVICIOS-(PM)-" + mproveedor.Text;
                string rutael = "C:/presupvisual/usuarios/proveedores-contratos/EdiLito/EL-SERVICIOS-(PM)-" + mproveedor.Text;
                string rutatl = "C:/presupvisual/usuarios/proveedores-contratos/Terminados/TL-SERVICIOS-(PM)-" + mproveedor.Text;
                //string rutalg = "//server/presupvisual/usuarios/proveedores-contratos/LitoGil/LG-SERVICIOS-(PM)-" + mproveedor.Text;
                //string rutael = "//server/presupvisual/usuarios/proveedores-contratos/EdiLito/EL-SERVICIOS-(PM)-" + mproveedor.Text;
                //string rutatl = "//server/presupvisual/usuarios/proveedores-contratos/Terminados/TL-SERVICIOS-(PM)-" + mproveedor.Text;
